    ...
    crossAjax({
        ...
        success:function(result){
            ...
            if(data.flag=='f0'||data.flag=='f1'){
                ...
                tem += '</div>';
                tem += '<a ontouchstart="" class="w_button w_button_small fl" id="gobackgame" href="veewo.com" style="width: 50px; margin-top: 10px;">继续游戏</a>';
	...
	function _createTopMenu () {
		...
		if (!_getTopMenu) {
			...
			_getTopMenu.innerHTML = [
				'<span style="position:relative;display:inline-block;width:20%;text-align:left;"><a id="directionMenuBtn_0" href="javascript:void(0);" class="menuBtn2 radius" style="top:-11px;margin-left:5px;"><span id="directionMenuBtn_1" class="menuBtn2-icon"></span><span id="directionMenuBtn_2" class="menuBtn2-desc">veewo.com</span></a></span>',
				'<span style="position:relative;display:inline-block;width:60%;text-align:center;"><a href="http://www.veewo.com"><img id="directionMenuBtnDuoPao" src="../resource/img/iconmap_topheader.png" /></a></span>',
